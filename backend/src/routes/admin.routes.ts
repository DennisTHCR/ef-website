...
export class AdminController {
  ...
  private async createTeacher(req: Request, res: Response) {
    try {
  ...
  private async addQuoteToTeacher(req: Request, res: Response) {
    try {
      const { id } = req.params;
      const { text } = req.body;
  ...
  private async addSubjectToTeacher(req: Request, res: Response) {
    try {
      const { id } = req.params;
